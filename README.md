About premailer-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/premailer-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5074&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/premailer-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `premailer` can be installed with `conda`:
...
```
mamba install premailer
```

It is possible to list all of the versions of `premailer` available on your platform with `conda`:
...
```
mamba search premailer --channel conda-forge
```
...
mamba repoquery search premailer --channel conda-forge

# List packages depending on `premailer`:
mamba repoquery whoneeds premailer --channel conda-forge

# List dependencies of `premailer`:
mamba repoquery depends premailer --channel conda-forge
```
